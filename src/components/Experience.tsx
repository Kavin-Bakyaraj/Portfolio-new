              ...
              {experiences.map((exp, index) => (
                ...
                >
                  ...
                  <motion.div
                    ...
                    className={`absolute left-6 w-4 h-4 rounded-full border-4 border-black z-10 hidden md:block ${
                      exp.current 
                            ...
                            <h3 className="text-2xl font-bold text-white mb-2 flex items-center">
                              ...
                              {exp.current && (
                                <motion.span
                                  ...
                                  className="ml-3 px-3 py-1 text-xs bg-gradient-to-r from-green-500 to-emerald-500 text-white rounded-full"
                                >
                                  Current
                                </motion.span>
                              )}
                      ...
                      <div className="flex flex-wrap gap-2">
                        {exp.technologies.map((tech, techIndex) => (
                          <motion.span
                            ...
                            className="px-3 py-1 text-sm rounded-full bg-white/10 text-white/80 hover:bg-white/20 hover:text-white transition-all duration-300"
                          >
                            {tech}
                          </motion.span>
                        ))}
